...
public class RunQuery {
	...
	private static Vector<String> mapNeurolexHashCodeNoSynonyms = 
		new Vector();
	 ...
	 * @param hashMap - the multihashmap storing all data in search
	 */
	public static void addToMultiHashMapHashCodeNoSynonyms(Vector<String> obtainedMap){
		for(String obtainedMapKey: obtainedMap){
			if(!mapNeurolexHashCodeNoSynonyms.contains(obtainedMapKey))
				mapNeurolexHashCodeNoSynonyms.add(obtainedMapKey);
		}
	}
