...
public class AwtG2DWrapper extends Graphics2D {
        ...
        private static org.eclipse.swt.graphics.Rectangle swtRect = new org.eclipse.swt.graphics.Rectangle(0,0,0,0);
    ...
    private static HashMap _fontRegister        = new HashMap();
        ...
        public AwtG2DWrapper(GC g, Device d) {
                super();
                gc = g;
                device = d;
        }
        ...
        public void setColor(Color c) {
                org.eclipse.swt.graphics.Color cachedColor = (org.eclipse.swt.graphics.Color)_colorRegister.get(c);
                if (cachedColor == null) {
                        cachedColor = new org.eclipse.swt.graphics.Color(device,c.getRed(),c.getGreen(),c.getBlue());
                        _colorRegister.put(c,cachedColor);
                }
        ...
        public void drawLine(double x1, double y1, double x2, double y2) {
                ...
                gc.setLineWidth(getTransformedLineWidth());
                gc.drawLine((int)(x1+_RectXYGap),(int)(y1+_RectXYGap),(int)(x2+_RectXYGap),(int)(y2+_RectXYGap));
        }
    ...
    public void setStroke(Stroke s) {
        ...
        public void drawOval(double x, double y, double width, double height) {
                ...
                gc.setLineWidth(getTransformedLineWidth());
                gc.drawOval((int)(_awtRect.getX()+_RectXYGap),(int)(_awtRect.getY()+_RectXYGap),(int)(_awtRect.getWidth()+_RectXYGap),(int)(_awtRect.getHeight()+_RectXYGap));
        }
        ...
        public void fillOval(double x, double y, double width, double height) {
                ...
                gc.fillOval((int)(_awtRect.getX()+_RectXYGap),(int)(_awtRect.getY()+_RectXYGap),(int)(_awtRect.getWidth()+_RectXYGap),(int)(_awtRect.getHeight()+_RectXYGap));
        }
        ...
        public void drawArc(double x, double y, double width, double height, double startAngle, double extent) {
                ...
                gc.setLineWidth(getTransformedLineWidth());
                gc.drawArc((int)(_awtRect.getX()+_RectXYGap),(int)(_awtRect.getY()+_RectXYGap),(int)(_awtRect.getWidth()+_RectXYGap),(int)(_awtRect.getHeight()+_RectXYGap),(int)(startAngle+_RectXYGap),(int)(startAngle+extent+_RectXYGap));
        }
        ...
        protected int getTransformedLineWidth() {
                ...
                return (int)(Math.max(_awtLineRect.getWidth(),1)+_RectXYGap);
        }
         ...
         * @param sRect
         */
        public static void getSwtRectFromAwt(Rectangle2D aRect, org.eclipse.swt.graphics.Rectangle sRect) {
                sRect.x = (int)(aRect.getX()+_RectXYGap);
                sRect.y = (int)(aRect.getY()+_RectXYGap);
                sRect.width             = (int)(aRect.getWidth()+_RectXYGap);
                sRect.height    = (int)(aRect.getHeight()+_RectXYGap);
        }
        ...
        public static int[] applyAffineTransformToPoly(double[] pts, AffineTransform at) {
                ...
                for(int i=0; i<pts.length/2; i++) {
                        ...
                        intPts[2*i] = (int)(_pt2D.getX()+_RectXYGap);
                        intPts[2*i+1] = (int)(_pt2D.getY()+_RectXYGap);
                }
                return intPts;
        }
