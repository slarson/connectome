 ...
 */
public class SWTArrow {

	public static final String  CLASSIC = "Arrow.CLASSIC"; //$NON-NLS-1$
	public static final String  SLEEK   = "Arrow.SLEEK"; //$NON-NLS-1$
	...
	public SWTArrow(String type, int length, int width){
		m_arrowType = type;
		if(length>0){
...
//    }
	...
	public void drawArrow(AwtG2DWrapper g2d, int sourceX, int sourceY, int destX, int destY, int vertexDiam){
	    Stroke oldStroke = g2d.getStroke();
		g2d.setStroke(m_arrowStroke);
