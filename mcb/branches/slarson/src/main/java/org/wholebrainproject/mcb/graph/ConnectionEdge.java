...
public class ConnectionEdge implements Edge{
	 ...
	 * @param strength
	 * @param reference
	 * @param sending - a node that represents the sending structure
	 * @param receiving - a string that represents the name of the receiving structure
	 */
	...
	public ConnectionEdge(String strength, String reference, String sending,
			Node receiving) {
		this(strength, reference);
		this.sendingStructureString = sending;
		this.receivingNode = receiving;
	}
	...
	public String getLabel() {
		...
		if (getProjectingNode() != null) {
			//FIXME bring back projecting cell info
	...
	public String getSendingNodeString() {
		return this.sendingStructureString;
	}
	...
	public String getReceivingNodeString() {
		return this.receivingStructureString;
	}
